...
class AgentRuntimeContext:
    ...
    project_root: str = ".writeagent/projects/default"
    tmp_root: str = ".writeagent/projects/default/tmp"
    evidence_root: str = ".writeagent/projects/default/evidence"
    cache_root: str = ".writeagent/projects/default/cache"
    locale: str = "zh-CN"
